        ...
        >
          <div className="flex items-center gap-2 px-4 py-3">
            <a
              ...
              className="flex-1 flex items-center justify-center gap-2 bg-[#2a5a3e] hover:bg-[#3d7a52] text-white rounded-xl h-11 text-sm font-semibold transition-colors"
            >
              <Phone size={16} />
              (657) 720-9054
            </a>
            ...
            <button
              ...
              className="w-9 h-9 flex items-center justify-center rounded-lg hover:bg-secondary/50 text-muted-foreground transition-colors -mr-1 shrink-0 cursor-pointer"
              aria-label="Dismiss"
            >
              <X size={16} />
            </button>
